...
.github/workflows/ci.yml contains the Windows/Linux hosted matrix. No GitHub upload
or hosted job was performed, per the user's instruction. Local Windows and Ubuntu
...
pre-push rejects every push, including tags. Hooks never stage/rewrite source and
